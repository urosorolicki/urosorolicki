...
const PROFILE = {
  ...
  cv: "/Uros_Orolicki_CV.pdf",
  summary:
    "DevOps Engineer with 4+ years of experience in cloud infrastructure and automation. Specializing in AWS, Kubernetes (EKS), Terraform, and GitOps with ArgoCD. Experience in enterprise banking infrastructure and data analytics platforms.",
  skills: {
    ...
    Monitoring: ["SumoLogic", "Sentry", "New Relic", "Datadog", "Cortex"],
    Programming: ["Python", "JavaScript (basic)"],
    Databases: ["PostgreSQL", "Elastic Stack"],
    VCS: ["Git"],
  },
  experience: [
    {
      ...
      company: "BlueGrid.io",
      period: "Sep 2025 – Nov 2025 (Part-time)",
      bullets: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Deployed and maintained Kubernetes clusters for mission-critical banking operations.",
...
const renderHelp = () => (
  <div className="space-y-1">
    ...
    {asList([
      ...
      "",
      "🎨 NEW: modern — switch to modern animated CV!",
      "",
      "Terminal commands:",
      "whoami — current user",
    ...
    <div className="text-xs text-zinc-500 mt-2">
      ...
      <br />Try: skills cloud, experience --recent, cat README.md, ls -l, modern
    </div>
  </div>
);
...
${p.desc}`).join("\n\n")}`;
      ...
      modern: () => {
        ...
        return <div className="text-cyan-400">🎨 Loading modern CV interface...</div>;
      },
    }),
    [theme]
  );
  ...
  useEffect(() => {
    if (mounted) {
      ...
      pushOutput(
        <div className="mt-1">
          Type <code>help</code> to get started. Try <code>modern</code> for the animated version!
        </div>
      );
    }
  }, [mounted]);
  ...
  return (
    <>
      <Head>
        <title>{PROFILE.name} - Terminal CV</title>
